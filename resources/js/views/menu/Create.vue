<template>
    <div class="content">
        <div class="container-fluid">
            <breadcrumb :options="['Menu Create']">
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="repeater" @submit.prevent="addMenu" @keydown="form.onKeydown($event)">
                                <div data-repeater-list="group-a">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-2" style="margin-top: 26px">
                                            <button type="submit" class="btn btn-success mo-mt-2 float-left" value="Add Menu">Add Menu</button>
                                        </div>
...
<script>
document.title = 'Menu Create | DadHQ';
export default {
    name: "Create",
    data() {
        return {
    ...
    methods: {
        addMenu(){
            this.form.post('/api/menu').then((response)=>{
